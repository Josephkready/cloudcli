      ...
      <div className={`flex items-center justify-between border-b border-border/60 ${isMobile ? 'px-3 py-2' : 'px-4 py-3'}`}>
        ...
        <div className={`flex items-center ${isMobile ? 'gap-1' : 'gap-2'}`}>
            ...
            <>
              {!remoteStatus.hasUpstream ? (
                <button
                  ...
                  disabled={anyPending}
                  className={`flex items-center gap-1 rounded-lg bg-primary px-2.5 py-1 text-sm text-primary-foreground transition-colors enabled:hover:bg-primary/90 ${disabledControlClasses}`}
                ...
                <>
                  ...
                  {behindCount > 0 && (
                    <button
                      ...
                      disabled={anyPending}
                      className={`flex items-center gap-1 rounded-lg bg-green-600 px-2.5 py-1 text-sm text-white transition-colors enabled:hover:bg-green-700 ${disabledControlClasses}`}
                  ...
                  {aheadCount > 0 && (
                    <button
                      ...
                      disabled={anyPending}
                      className={`flex items-center gap-1 rounded-lg bg-orange-600 px-2.5 py-1 text-sm text-white transition-colors enabled:hover:bg-orange-700 ${disabledControlClasses}`}
          ...
          <button
            ...
            className={`rounded-lg transition-colors enabled:hover:bg-accent ${disabledControlClasses} ${isMobile ? 'p-1' : 'p-1.5'}`}
