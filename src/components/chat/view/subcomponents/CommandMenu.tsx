...
export default function CommandMenu({
  ...
  if (commands.length === 0) {
    return renderInPortal(
      <div
        ref={menuRef}
        className="command-menu command-menu-empty border border-border bg-popover/95 text-sm text-muted-foreground transition-[opacity,transform] duration-base ease-in-out"
        style={{
          ...menuBaseStyle,
          ...menuPosition,
          overflowY: 'hidden',
  ...
  return renderInPortal(
    <div
      ...
      className="command-menu border border-border bg-popover/95 text-popover-foreground transition-[opacity,transform] duration-base ease-in-out"
