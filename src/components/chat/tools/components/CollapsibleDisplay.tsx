      ...
      >
        ...
        {showRawParameters && rawContent && (
          <Collapsible className="mt-2">
            ...
            <CollapsibleContent>
              <pre className="mt-1 max-h-80 overflow-y-auto whitespace-pre-wrap break-words rounded border border-border/40 bg-muted p-2 font-mono text-[11px] text-muted-foreground">
                {rawContent}
              </pre>
            </CollapsibleContent>
          </Collapsible>
